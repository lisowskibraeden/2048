...
class game:
    ...
    def restart(self):
        game.printBoard(self, game.board)
    ...
    while running:
        for i in range(len(g.board)):
            for x in range(len(g.board)):
                ...
                if g.board[i][x] != 0:
                    pygame.draw.rect(screen, colors[int(math.log(g.board[i][x], 2))], pygame.Rect(50 + 500/5 * i, 50 + 500/5 * x, 100, 100), 0, 3)
                    screen.blit(num, ((-num_width / 2) + 100 + 500/5 * i, (-num_height / 2) + 100 + 500/5 * x))
                else:
                    pygame.draw.rect(screen, 'gray', pygame.Rect(50 + 500/5 * i, 50 + 500/5 * x, 100, 100), 0, 3)
